...
class AddressBook(UserDict):
    ...
    def save_to_file(self, filename):
        ...
        for rec in self.data.values():
            data_value = {rec.name.value:{"name":rec.name.value, "phones":[str(phone) for phone in rec.phones], "email":str(rec.email), "address":str(rec.address), "birthday":str(rec.birthday)}}
