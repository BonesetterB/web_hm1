...
class AddressBook(UserDict):
    ...
    def save_to_file(self, filename):
        ...
        for rec in self.data.values():
            ...
            data_value = {rec.name.value:{"name":rec.name.value, "phones":[phone for phone in rec.phones], "email":rec.email.value, "address":rec.address.value, "birthday":rec.birthday.value}}
